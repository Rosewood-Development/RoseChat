...
//import dev.rosewood.rosechat.message.tokenizer.SlowMessageTokenizer;
...
//                        MessageTokenizer.from(message, viewer, message.getMessage(), sender.isConsole(),
...
//            if (ConfigurationManager.Setting.USE_MARKDOWN_FORMATTING.getBoolean()) {
//                componentBuilder.append(
//                        MessageTokenizer.from(message, viewer, before, true,
//                                Tokenizers.DISCORD_EMOJI_BUNDLE,
//                                Tokenizers.FROM_DISCORD_BUNDLE,
//                                Tokenizers.MARKDOWN_BUNDLE,
//                                Tokenizers.DISCORD_FORMATTING_BUNDLE,
...
//            if (ConfigurationManager.Setting.USE_MARKDOWN_FORMATTING.getBoolean()) {
//                componentBuilder.append(
//                        MessageTokenizer.from(message, viewer, formatColor + message.getMessage(), sender.isConsole(),
//                                Tokenizers.DISCORD_EMOJI_BUNDLE,
//                                Tokenizers.FROM_DISCORD_BUNDLE,
//                                Tokenizers.MARKDOWN_BUNDLE,
//                                Tokenizers.DISCORD_FORMATTING_BUNDLE,
...
//            if (ConfigurationManager.Setting.USE_MARKDOWN_FORMATTING.getBoolean()) {
//                componentBuilder.append(
//                        MessageTokenizer.from(message, viewer, after, true,
//                                Tokenizers.DISCORD_EMOJI_BUNDLE,
//                                Tokenizers.FROM_DISCORD_BUNDLE,
//                                Tokenizers.MARKDOWN_BUNDLE,
//                                Tokenizers.DISCORD_FORMATTING_BUNDLE,
