...
public class RainbowTokenizer implements Tokenizer<RainbowToken> {
    ...
    public RainbowToken tokenize(MessageWrapper messageWrapper, String input) {
        ...
        if (matcher.find() && matcher.start() == 0) {
            ...
            String saturationGroup = ComponentColorizer.getCaptureGroup(matcher, "saturation");
            ...
            String brightnessGroup = ComponentColorizer.getCaptureGroup(matcher, "brightness");
