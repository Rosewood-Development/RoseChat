...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        CHAT_REPLACEMENTS("chat-settings.chat-replacements", new RoseSettingSection(
                ...
                "When a message containing the 'text' is sent in chat, it will be replaced with the 'replacment'.", "These can be used for custom emotes, color codes or general replacements.", "These replacements can be used with placeholders in placeholder.yml.", "These also support regular expressions."),
        ...
        CHAT_CHANNELS("chat-channels", new RoseSettingSection(
                new RoseSettingValue("global", new RoseSettingSection(
                        ...
                        new RoseSettingValue("swear-checking-enabled", false, "Overriden Values", "These settings can be used to override the default values in specific chat channels.", "chat-placeholders-enabled: false", "disabled-tags:", "  - money", "disabled-replacements:", "  - kawaii", "caps-chekcing-enabled: false", "url-checking-enabled: false", "spam-checking-enabled: false")
