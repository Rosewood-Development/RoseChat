...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        PACKET_EVENT_PRIORITY("chat-settings.packet-event-priority", "NORMAL",
                "The event priority for adding the delete message button to messages.",
                "This may need to be modified if another plugin also uses ProtocolLib to edit messages.",
                "Valid Options: LOWEST, LOW, NORMAL, HIGH, HIGHEST"),
