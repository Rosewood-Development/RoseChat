...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        USE_IGN_WITH_DISCORD("chat-settings.use-minecraft-ign-with-discord", true,
                ...
                "Requires DiscordSRV"),
        DELETE_DISCORD_MESSAGES("chat-settings.delete-discord-messages", true,
                "Should messages sent in Discord, via DiscordSRV, be deleted when the same message is deleted in-game.",
