...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        DELETE_CLIENT_MESSAGE_FORMAT("chat-formats.delete-client-message", "{delete-message}",
                "The format of a delete client message button."),
        DELETE_OWN_MESSAGE_FORMAT("chat-formats.delete-own-message", "{delete-message}",
                "The format of a delete own message button."),
        DELETE_OTHER_MESSAGE_FORMAT("chat-formats.delete-other-message", "{delete-message}",
                "The format of a delete other message button."),
        DELETED_MESSAGE_FORMAT("chat-formats.deleted-message", "{delete-message}",
        ...
        DISCORD_TO_MINECRAFT_FORMAT("chat-formats.discord-to-minecraft", "{from-discord}",
